...
public class WithdrawAcc extends JFrame implements Serializable {
    ...
    public WithdrawAcc() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if(a==0)
                    {
                        ...
                        FileIO.bank.logWithdrawalReason(aacountNum, reason);
        ...
        JLabel lblReason = new JLabel("Withdrawal Reason:");
        lblReason.setHorizontalAlignment(SwingConstants.RIGHT);
        lblReason.setBounds(0, 118, 106, 14);
        contentPane.add(lblReason);

        comboBox = new JComboBox<String>();
        comboBox.setBounds(116, 115, 216, 20);
        comboBox.addItem("Cash Needed");
        comboBox.addItem("Bill Payment");
        comboBox.addItem("Transfer to another account");
        comboBox.addItem("Transfer to self account");
